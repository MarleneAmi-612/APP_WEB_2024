...
if ($_SERVER["REQUEST_METHOD"] == "POST") { //si el método fue post entonces 
    ...
    if ($password !== $confirmar_pass) {
        ...
        if (empty($username) || empty($password)) {
            ...
            $sql = "INSERT INTO usuarios (username, passwordd, privilegio) VALUES ('$username', '$password_hashed', 'usuario')";
...
<body>
    ...
    <footer>
        <p>Curso de Django con AmiLine &copy; 2024 | Visitado el: 01/10/24</p>
    </footer>
</body>
</html>